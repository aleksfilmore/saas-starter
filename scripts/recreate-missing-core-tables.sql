-- Idempotent recreation for critical tables that may have been dropped.
-- Run manually psql -f scripts/recreate-missing-core-tables.sql or via your migration helper.

-- anonymous_posts supplementary columns (skip if exist)
DO $$ BEGIN
...
-- wall_post_reactions (in case missing; kept minimal)
...
-- ritual_entries basic recreation (only essential columns; extend if needed)
