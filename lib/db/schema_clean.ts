...
export const cultBubbleMembers = pgTable('cult_bubble_members', {
  id: text('id').primaryKey(),
  bubbleId: text('bubble_id').notNull().references(() => cultBubbles.id),
  userId: text('user_id').notNull().references(() => users.id),
...
export type NewCultBubble = typeof cultBubbles.$inferInsert;
export type CultBubbleMember = typeof cultBubbleMembers.$inferSelect;
export type NewCultBubbleMember = typeof cultBubbleMembers.$inferInsert;
export type BubblePost = typeof bubblePosts.$inferSelect;
export type NewBubblePost = typeof bubblePosts.$inferInsert;
