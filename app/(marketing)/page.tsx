  ...
  return (
    <div className="bg-background text-foreground">
      ...
      <section className="relative overflow-hidden py-24">
        ...
        <div className="pointer-events-none absolute inset-0 -z-20 bg-gradient-to-br from-background via-card to-background" />
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20 items-center min-h-[500px]">
            ...
            <div className="flex flex-col justify-center text-center lg:text-left">
              ...
              <p className="mb-8 max-w-xl text-lg text-muted-foreground lg:mx-0 mx-auto leading-relaxed">
                <span className="text-glitch-pink font-bold text-xl">CTRL+ALT+BLOCK</span> is the savage, AI-powered breakup ritual for
                deleting old attachments and rebooting your life. It&apos;s not
                therapy – it&apos;s a <span className="text-glitch-pink font-bold bg-glitch-pink/20 px-2 py-1 rounded">digital exorcism</span>.
              </p>
              ...
              <div className="flex justify-center lg:justify-start">
                <a href="/sign-up">
                  <Button
                    size="lg"
                    className="rounded-full bg-gradient-to-r from-glitch-pink via-primary to-secondary hover:from-glitch-pink/80 hover:via-primary/80 hover:to-secondary/80 px-8 py-4 text-lg text-white font-bold shadow-neon-pink hover:shadow-neon-pink/80 transition-all duration-300 group animate-pulse-slow"
                  >
      ...
      {/* ───────────────────────────────── Feature grid */}
      <section id="how-it-works" className="relative bg-card/30 border-y border-border/50 py-24 overflow-hidden">
        {/* Background patterns */}
        <div className="absolute inset-0 bg-gradient-to-br from-secondary/5 via-transparent to-accent/5"></div>
        
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 relative">
          <div className="mb-16 text-center">
            <h2 className="text-4xl font-bold bg-gradient-to-r from-glitch-pink via-primary to-accent bg-clip-text text-transparent">
              Your Arsenal for Emotional Recovery
            </h2>
            <p className="mt-4 text-lg text-muted-foreground">
              Tools engineered for <span className="text-glitch-pink font-bold bg-glitch-pink/20 px-2 py-1 rounded">structured-chaos</span> healing.
            </p>
          </div>

          <div className="grid grid-cols-1 gap-8 md:grid-cols-3">
            {/* AI-Powered Tools */}
            <div className="group rounded-2xl border-2 border-glitch-pink/50 bg-card/90 backdrop-blur-sm p-8 shadow-neon-pink/50 transition-all duration-300 hover:scale-105 hover:shadow-neon-pink hover:border-glitch-pink relative overflow-hidden">
              <div className="absolute inset-0 bg-gradient-to-br from-glitch-pink/10 via-transparent to-primary/10"></div>
              <div className="relative z-10">
                <div className="mx-auto mb-6 flex h-16 w-16 items-center justify-center rounded-full bg-gradient-to-br from-glitch-pink to-primary shadow-neon-pink">
                  <Bot className="h-8 w-8 text-white" />
                </div>
                <h3 className="mb-3 text-xl font-semibold text-center text-foreground">AI-Powered Tools</h3>
                <p className="text-base text-muted-foreground text-center leading-relaxed">
                  Closure chats, savage breakup letters, tarot-style diagnostics – all generated by our resident <span className="text-glitch-pink font-bold">cyber-witch</span>.
                </p>
                <div className="mt-4 flex justify-center">
                  <span className="inline-flex items-center px-3 py-1 rounded-full text-xs font-medium bg-glitch-pink/20 text-glitch-pink border border-glitch-pink/30">
      ...
      <section className="relative py-24 overflow-hidden">
        ...
        <div className="mx-auto max-w-5xl px-4 text-center sm:px-6 lg:px-8 relative">
          <h2 className="text-4xl md:text-5xl font-bold bg-gradient-to-r from-glitch-pink via-primary to-accent bg-clip-text text-transparent">
            Pick your protocol
          </h2>
          <p className="mx-auto mt-4 max-w-2xl text-lg text-muted-foreground">
            Start free, stay petty. Upgrade when you want the full <span className="text-glitch-pink font-bold bg-glitch-pink/20 px-2 py-1 rounded">spellbook</span>.
          </p>
          ...
          <div className="mt-16 grid gap-8 md:grid-cols-2 max-w-4xl mx-auto">
            ...
            {/* basic w/ 7-day trial */}
            <div className="relative rounded-2xl border-2 border-glitch-pink shadow-neon-pink ring-4 ring-glitch-pink/20 bg-card/95 backdrop-blur-sm group hover:shadow-neon-pink/80 transition-all duration-300 hover:scale-105">
              <div className="absolute -top-4 left-1/2 transform -translate-x-1/2 rounded-full bg-gradient-to-r from-glitch-pink to-primary px-6 py-2 text-sm font-bold text-white shadow-neon-pink animate-pulse-slow">
                <Sparkles className="w-4 h-4 mr-1 inline" />
                🔥 7-Day FREE Trial
              </div>
              <div className="absolute inset-0 bg-gradient-to-br from-glitch-pink/15 via-transparent to-primary/15 rounded-2xl"></div>
              <div className="p-8 relative z-10">
                <h3 className="text-2xl font-semibold text-foreground">Basic</h3>
                <p className="mt-2 text-sm text-muted-foreground">
                  Full ritual toolkit + daily AI.
                </p>
                <p className="mt-6 text-5xl font-extrabold bg-gradient-to-r from-glitch-pink to-primary bg-clip-text text-transparent">$9</p>
                <p className="text-sm text-muted-foreground">per month</p>
                <ul className="mt-6 space-y-3 text-left text-sm">
                  <li className="flex items-center text-muted-foreground">
                    <span className="w-4 h-4 mr-3 text-glitch-pink">✓</span>
                ...
                <a href="/sign-up" className="mt-8 block">
                  <Button
                    size="lg"
                    className="w-full rounded-xl bg-gradient-to-r from-glitch-pink to-primary hover:from-glitch-pink/80 hover:to-primary/80 text-white font-bold shadow-neon-pink hover:shadow-neon-pink/80 transition-all duration-300 group animate-pulse-slow"
                  >
      ...
      <section className="relative py-24 overflow-hidden">
        ...
        <div className="mx-auto max-w-3xl px-4 text-center sm:px-6 lg:px-8 relative">
          ...
          <p className="mt-6 text-lg text-muted-foreground leading-relaxed max-w-2xl mx-auto">
            Tap below, grab your <span className="text-glitch-pink font-bold bg-glitch-pink/20 px-2 py-1 rounded">7-day FREE trial</span>, and start the emotional
            reboot today. <span className="text-glitch-pink font-bold">No regrets, just upgrades.</span>
          </p>
          <div className="mt-10">
            <a href="/sign-up">
              <Button
                size="lg"
                className="rounded-xl bg-gradient-to-r from-glitch-pink via-primary to-accent hover:from-glitch-pink/80 hover:via-primary/80 hover:to-accent/80 px-12 py-6 text-xl font-bold text-white shadow-neon-pink hover:shadow-neon-pink/80 transition-all duration-300 group animate-pulse-slow"
              >
                <Sparkles className="mr-3 h-6 w-6 group-hover:animate-pulse" />
                🔥 Enter CTRL+ALT+BLOCK FREE
