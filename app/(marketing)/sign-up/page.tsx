...
function SignUpButton() {
  ...
  return (
    <button
      type="submit"
      disabled={pending}
      className="w-full bg-primary text-primary-foreground hover:bg-primary/80 font-medium rounded-lg text-sm px-5 py-2.5 text-center disabled:opacity-50"
    >
        ...
        <form action={formAction} className="grid gap-4">
          <div className="grid gap-2">
            ...
            <input
              ...
              required
              className="bg-muted border border-border text-foreground text-sm rounded-lg focus:ring-primary focus:border-primary block w-full p-2.5"
            />
          </div>
          <div className="grid gap-2">
