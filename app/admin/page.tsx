      ...
      <div className="relative z-10">
            ...
            <div className="flex items-center justify-between">
              ...
              <div className="flex items-center space-x-2 sm:space-x-4">
                <Link href="/quiz">
                  <Button
                    size="sm"
                    className="bg-gradient-to-r from-purple-500 to-pink-500 hover:from-purple-600 hover:to-pink-600 px-3 sm:px-6 text-white border-0 hover:scale-105 transition-all text-xs sm:text-sm"
                  >
                ...
                <Link href="/sign-in">
                  <Button
                    variant="outline"
                    size="sm"
                    className="border-gray-500 text-gray-300 hover:text-white hover:border-purple-400 transition-all px-3 sm:px-4 text-xs sm:text-sm"
                  >
                    Sign In
                  </Button>
                </Link>
        ...
        <div className="px-4 sm:px-6 py-12 sm:py-16 md:py-20">
          <div className="max-w-5xl mx-auto text-center">
            <div className="inline-flex items-center px-3 sm:px-4 py-2 rounded-full bg-purple-900/30 border border-purple-500/30 text-purple-300 text-xs sm:text-sm mb-6 sm:mb-8">
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center space-y-2 sm:space-y-0 sm:space-x-8 text-xs sm:text-sm text-gray-400 px-4">
              ...
              {features.map((feature, index) => (
                <Card key={index} className="bg-gray-800/60 border-gray-600/50 hover:border-purple-500/50 transition-all duration-300 group">
                  <CardContent className="p-6 sm:p-8">
                    <div className={`inline-flex p-3 sm:p-4 rounded-full bg-gradient-to-r ${feature.gradient} mb-4 sm:mb-6 group-hover:scale-110 transition-transform duration-300`}>
                      {feature.icon}
                    </div>
